		...
		<div class="row">
			<div class="col-md-3">
				<div class="card" >
					...
					<div class="card-body">
						<div class="container-fluid" id="Layer1" style="width:100%; height:480px; overflow: none; overflow-x: hidden;">
							<?php
							...
							while ($verCS=mysqli_fetch_array($consCS)) {
								...
								<div>
									<div class="card" style="width:250px; border: 1px solid #5D00B9">
										<div class="card-body">
								    		<h5 class="card-title"><?php echo $verCS['username'] ?></h5>
								    		<p class=""><small><?php echo $verCS['fechaCom'].' '.$verCS['hora'] ?></small></p>		
								    		<p class=""><?php echo $verCS['comSoft'] ?><p>
								  		</div>								
								 	</div>
								</div>&nbsp
				...
				<div class="col-md-6">
					<div class="container-fluid" id="Layer2" style="width:100%; height:512px; overflow: auto;">
								<center>
									<table>
										<br>
										<tr>
