...
if (isset($_POST['regBtn'])) 
{
    ...
    $resul = mysqli_query($cnx,$insertar);
    if ($result) {
    	header("Location:pruebasoft.php");
    }else{
    	echo 'error';
    }
...
if (isset($_POST['buscar'])) 
{
	...
	{
		$sql="SELECT * FROM software where nombreSoft ='$_POST[nombreSoft]'";
				...
				<div class="col-md-4">
					<form class="login" method="post">
						...
						<div class="input-group">
							...
							<input id="nombre" type="text" class="form-control input-lg" placeholder="Nombre del software" name="nombreSoft" autofocus value="<?php if (isset($_POST['buscar'])) echo $campo['nombreSoft']?>">
						</div><br>


						<div class="input-group">
							<span class="input-group-addon"></span>
							<input class="btn form-control input-lg" type="file" accept="image/png, .jpeg, .jpg, image/gif" name="foto" id="foto">
						</div><br>
						...
						<button type="submit" class="btn btn-primary btn-lg btn-warning" name="regBtn">Registrar</button>
